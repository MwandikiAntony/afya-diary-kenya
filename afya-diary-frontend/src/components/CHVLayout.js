...
const NAV = [
  { section: "Main" },
  { to: "/chv-dashboard", label: "Dashboard", icon: "dashboard" },
  { to: "/chv-patients",  label: "My Patients", icon: "patients" },
  { to: "/chv-reports",   label: "Reports",   icon: "reports" },
  { section: "Wellness" },
  ...
  { section: "Account" },
  { to: "/chv-profile", label: "My Profile", icon: "profile" },
];
    ...
    <>
      ...
      <style>{`
        *,*::before,*::after{box-sizing:border-box}
        :root{
          --pur-900:#4A148C;--pur-800:#6A1B9A;--pur-600:#8E24AA;--pur-400:#CE93D8;--pur-100:#F3E5F5;
        ...
        .sb{width:var(--sidebar);background:var(--pur-900);display:flex;flex-direction:column;flex-shrink:0;overflow-y:auto;overflow-x:hidden;z-index:50;transition:transform .3s ease}
        ...
        .sb-icon{width:38px;height:38px;background:#8E24AA;border-radius:8px;display:flex;align-items:center;justify-content:center;flex-shrink:0;font-size:1.2rem}
        .sb-name{font-family:var(--font-d);font-size:1.05rem;font-weight:600;color:#fff;line-height:1.1}
        .sb-sub{font-size:.65rem;color:var(--pur-400);font-weight:400;letter-spacing:.08em;text-transform:uppercase}
        .sb-nav{flex:1;padding:12px 10px}
        .sb-sec{font-size:.62rem;font-weight:600;color:var(--pur-400);text-transform:uppercase;letter-spacing:.1em;padding:8px 10px 3px;margin-top:12px}
        ...
        .sb-link.act{background:rgba(206,147,216,.15);color:var(--pur-400)}
        ...
        .sb-avatar{width:32px;height:32px;border-radius:50%;background:var(--pur-600);display:flex;align-items:center;justify-content:center;font-weight:600;font-size:.75rem;color:#fff;flex-shrink:0}
        .sb-uname{font-size:.82rem;font-weight:500;color:#fff;line-height:1.2}
        .sb-urole{font-size:.68rem;color:var(--pur-400)}
        ...
        .t-search:focus-within{border-color:#CE93D8;box-shadow:0 0 0 3px rgba(206,147,216,.1);background:#fff}
      ...
      <div className="shell">
        ...
        <aside className={`sb${open ? " open" : ""}`}>
          <div className="sb-brand">
            <Link to="/chv-dashboard" className="sb-logo">
              <div className="sb-icon">🌿</div>
              <div>
                <div className="sb-name">AfyaDiary</div>
                <div className="sb-sub">Kenya · CHV</div>
              </div>
            </Link>
          </div>
          ...
          <div className="sb-foot">
            <div className="sb-user">
              ...
              <div>
                <div className="sb-uname">{user.name || "CHV Worker"}</div>
                <div className="sb-urole">Community Health</div>
              </div>
            </div>
          </div>
        </aside>
