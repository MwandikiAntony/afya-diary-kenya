...
// PublicPages exports: Security, Careers, FAQ, MobileApp, NotFound
...
// ── AI / Wellness pages ───────────────────────────────────────────────────────
// AIChat connects to Python FastAPI backend via AfyaChat (src/utils/afya.js)
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/chemist/patient/:shaNumber"
          element={<ChemistPatientPage />} />
        <Route path="/chemist/dispense/:shaNumber"
          element={<DispensePage />} />
        <Route path="/chemist/dispense"
          element={<ProtectedRoute role="chemist"><DispensePage /></ProtectedRoute>} />
        <Route path="/chemist/add-record/:shaNumber"
          element={<AddRecord />} />
        <Route path="/chemist/add-record"
          element={<AddRecord />} />
        <Route path="/chemist/add-medicine"
          element={<ProtectedRoute role="chemist"><AddMedicinePage /></ProtectedRoute>} />
        <Route path="/chemist/add-patient"
          element={<AddPatientPage />} />
        <Route path="/chemist/assign-chv"
          element={<ProtectedRoute role="chemist"><AssignCHVPage /></ProtectedRoute>} />
        ...
        {/* ── AI / Wellness ───────────────────────────────────────────────── */}
        {/*
          AIChat uses AfyaChat class (src/utils/afya.js) which connects to:
            REST : REACT_APP_AFYA_BACKEND_URL/api/v1/sessions/start
            WS   : wss://REACT_APP_AFYA_BACKEND_URL/ws/{session_id}
          These routes are open (no ProtectedRoute) so any role can access wellness.
        */}
